...
public class TbaPdfInvoice
{
   ...
   private void fillDescription(boolean isCreditNote) throws IOException
   {
      ...
      if (System.getenv("TBA_MAIL_ON") != null)
      {
         writeText(mPage1, "Let op! Nieuw rekeningnummer: ", PDType1Font.TIMES_BOLD, 15, 100, 160);
         writeText(mPage1, "IBAN : BE63 6451 0754 1208 – BIC : JVBABE22", PDType1Font.TIMES_BOLD, 15, 100, 140);
      }
   }
   ...
   private void fillSubcustomers() throws IOException
   {
