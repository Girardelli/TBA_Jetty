...
public final class IBANCheckDigit implements Serializable
{
   ...
   public String calculateOGM(String invoiceNr)
   {
      ...
      // +++191/1000/69307+++
      // log.info("+++" + code.substring(0, 3) + "/" + code.substring(3, 7) + "/" +
      // code.substring(7, 10) + vCostFormatter.format(y) + "+++");
    ...
    * @throws CheckDigitException if an error occurs calculating the modulus for
    *                             the specified code
    */
