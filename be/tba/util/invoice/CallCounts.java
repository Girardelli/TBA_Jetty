...
class CallCounts
{
    ...
    * 
    * 
    * public void setLongFwdCalls(int longFwdCalls) { LongFwdCalls =
    * longFwdCalls; }
    * 
    * 
    ...
    * 
    * 
    * private void init() { InCalls = 0; OutCalls = 0; SmsCalls = 0; FwdCalls =
    * 0; AgendaCalls = 0; FaxCalls = 0; LongCalls = 0; LongCallSec = 0;
    * LongFwdCalls = 0; LongFwdCallSec = 0; Level3Calls = 0; Level2Calls = 0;
    * Level1Calls = 0; TotalCalls = 0; LastInvoiceItem = 0; }
    */
}
