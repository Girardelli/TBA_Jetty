...
public class WoltersKluwenImport
{
   ...
   private static final String[] kKwartalen = { "1", "1", "1", "2", "2", "2", "3", "3", "3", "4", "4", "4" };
   ...
   {
      // force the use of the ',' decimal separator by using explicit Belgium
      // localization
...
//            String dateStr = vEntry.getInvoiceDate();
         ...
         xmlBuf.append(String.format("%4d%04d", vEntry.getYear(), vEntry.getYearSeqNr()));
