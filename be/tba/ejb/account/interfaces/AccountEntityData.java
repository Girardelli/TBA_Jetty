...
// implements java.io.Serializable
{
   ...
   public String toNameValueString()
   {
      StringBuffer str = new StringBuffer();
		...
		str.append("UserId='" + ((this.userId != null) ? this.userId : "") +
		...
		"',LastLogin='" + ((this.lastLogin != null) ? this.lastLogin : "") +
		"',LastLoginTS=" + getLastLoginTS() +
		",PrevLoginTS=" + getPreviousLoginTS() +
		",IsRegistered=" + getIsRegistered() +
		",IsAutoRelease=" + getIsAutoRelease() +
		",IsXmlMail=" + getIsXmlMail() +
		",Is3W=" + getIs3W() +
		...
		",MailHour1=" + getMailHour1() +
		",MailMinutes1=" + getMailMinutes1() +
		",MailHour2=" + getMailHour2() +
		",MailMinutes2=" + getMailMinutes2() +
		",MailHour3=" + getMailHour3() +
		",MailMinutes3=" + getMailMinutes3() +
		",FacStdInCall=" + getFacStdInCall() +
		",FacOutLevel1=" + getFacOutLevel1() +
		",FacOutLevel2=" + getFacOutLevel2() +
		",FacOutLevel3=" + getFacOutLevel3() +
		",IsPriceAgendaFixed=" + getIsPriceAgendaFixed() +
		",FacAgendaCall=" + getFacAgendaCall() +
		",AgendaPriceUnit=" + getAgendaPriceUnit() +
		",FacSms=" + getFacSms() +
		...
		",FacFaxCall=" + getFacFaxCall() +
		",HasSubCustomers=" + getHasSubCustomers() +
		",SuperCustomer='" + ((this.superCustomer != null) ? this.superCustomer : "") +
		"',CountAllLongCalls=" + getCountAllLongCalls() +
		",CountLongFwdCalls=" + getCountLongFwdCalls() +
		",NoBtw=" + getNoBtw() +
		",NoEmptyMails=" + getNoEmptyMails() +
		",TextMail=" + getTextMail() +
		",FacLong=" + getFacLong() +
		",FacLongFwd=" + getFacLongFwd() +
		",FacTblMinCalls_I=" + getFacTblMinCalls_I() +
		",FacTblMinCalls_II=" + getFacTblMinCalls_II() +
		",FacTblMinCalls_III=" + getFacTblMinCalls_III() +
		",FacTblMinCalls_IV=" + getFacTblMinCalls_IV() +
		",FacTblStartCost_I=" + getFacTblStartCost_I() +
		",FacTblStartCost_II=" + getFacTblStartCost_II() +
		",FacTblStartCost_III=" + getFacTblStartCost_III() +
		",FacTblStartCost_IV=" + getFacTblStartCost_IV() +
		",FacTblExtraCost_I=" + getFacTblExtraCost_I() +
		",FacTblExtraCost_II=" + getFacTblExtraCost_II() +
		",FacTblExtraCost_III=" + getFacTblExtraCost_III() +
		",FacTblExtraCost_IV=" + getFacTblExtraCost_IV() +
		",IsMailInvoice=" + getIsMailInvoice() +
		",InvoiceEmail='" + ((this.invoiceEmail != null) ? this.invoiceEmail : "") + "' ");
      return (str.toString());
   }
   ...
   public String toValueString()
   {
      ...
      // client'. ',0 ,0 ,0 ,0 ,'')
		str.append("'0','" + ((this.userId != null) ? this.userId : "") +
		"','" + ((this.password != null) ? this.password : "") +
		"','" + ((this.fwdNumber != null) ? this.fwdNumber : "") +
		"','" + ((this.role != null) ? this.role : "") +
		"','" + ((this.fullName != null) ? this.fullName : "") +
		"','" + ((this.custFilter != null) ? this.custFilter : "") +
		"','" + ((this.stateFilter != null) ? this.stateFilter : "") +
		"','" + ((this.dirFilter != null) ? this.dirFilter : "") +
		"','" + ((this.lastLogin != null) ? this.lastLogin : "") +
		"'," + getLastLoginTS() +
		"," + getPreviousLoginTS() +
		"," + getIsRegistered() +
		"," + getIsAutoRelease() +
		"," + getIsXmlMail() +
		"," + getIs3W() +
		",'" + ((this.w3_PersonId != null) ? this.w3_PersonId : "") +
		"','" + ((this.w3_CompanyId != null) ? this.w3_CompanyId : "") +
		"','" + ((this.email != null) ? this.email : "") +
		"','" + ((this.gsm != null) ? this.gsm : "") +
		"'," + getInvoiceType() +
		"," + getLastInvoiceTime() +
		"," + getLastMailTime() +
		"," + getMailHour1() +
		...
		"','" + ((this.attToName != null) ? this.attToName : "") +
		"','" + ((this.street != null) ? this.street : "") +
		"','" + ((this.city != null) ? this.city : "") +
		"','" + ((this.btwNumber != null) ? this.btwNumber : "") +
		"'," + getNoInvoice() +
		"," + getFacFaxCall() +
		"," + getHasSubCustomers() +
		",'" + ((this.superCustomer != null) ? this.superCustomer : "") +
		"'," + getCountAllLongCalls() +
		"," + getCountLongFwdCalls() +
		"," + getNoBtw() +
		"," + getNoEmptyMails() +
		"," + getTextMail() +
		"," + getFacLong() +
		"," + getFacLongFwd() +
		"," + getFacTblMinCalls_I() +
		"," + getFacTblMinCalls_II() +
		"," + getFacTblMinCalls_III() +
		"," + getFacTblMinCalls_IV() +
		"," + getFacTblStartCost_I() +
		"," + getFacTblStartCost_II() +
		"," + getFacTblStartCost_III() +
		"," + getFacTblStartCost_IV() +
		"," + getFacTblExtraCost_I() +
		"," + getFacTblExtraCost_II() +
		"," + getFacTblExtraCost_III() +
		"," + getFacTblExtraCost_IV() +
		"," + getIsMailInvoice() +
		",'" + ((this.invoiceEmail != null) ? this.invoiceEmail : "") + "'");
      return (str.toString());
   }
