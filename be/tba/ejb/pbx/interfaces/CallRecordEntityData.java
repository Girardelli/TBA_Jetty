...
public class CallRecordEntityData extends AbstractData
{
   ...
   public String toNameValueString()
   {
      ...
      str.append(
		  ...
		  ",IsDocumented=" + getIsDocumented() +
		  ",IsReleased=" + getIsReleased() +
		  ",IsNotLogged=" + getIsNotLogged() +
		  ",IsAgendaCall=" + getIsAgendaCall() +
		  ",IsSmsCall=" + getIsSmsCall() +
		  ",IsForwardCall=" + getIsForwardCall() +
		  ",IsImportantCall=" + getIsImportantCall() +
		  ",Is3W_call=" + getIs3W_call() +
